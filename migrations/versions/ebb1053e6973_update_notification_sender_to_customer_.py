...
Revision ID: ebb1053e6973
Revises: 08cabcbf31cd
Create Date: 2024-12-03 12:24:36.958211
...
revision = 'ebb1053e6973'
down_revision = '08cabcbf31cd'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('id', sa.String(length=6), nullable=False),
    sa.Column('customer_id', sa.String(length=6), nullable=True),
    ...
    sa.Column('professional_id', sa.String(length=6), nullable=True),
    sa.Column('service_id', sa.String(length=6), nullable=True),
    sa.Column('status', sa.String(length=50), nullable=False),
    sa.Column('request_date', sa.Date(), nullable=False),
    sa.Column('completion_date', sa.DateTime(), nullable=True),
    sa.Column('rejected_by', sqlite.JSON(), nullable=True),
